...
export default function Nevbar() {
  ...
  useEffect(()=>{
    ...
    return ()=>{
     ...
     const nevitem = (<>
      ...
      <li><a href='/contectus'>Contect</a></li>
    </>)
  ...
  return (
    ...
    <div className={`max-w-screen-2xl dark:bg-white dark:text-black container mx-auto md:px-20 px-4 fixed top-0 left-0 right-0 z-50
     ${sticky?"sticky-nevbar shadow-md bg-gray-800 duration-300 transition-all ease-in-out":"" }`}>
  ...
  <div className="navbar-start">
    <div className="dropdown">
      ...
      <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">{nevitem}</ul>
    </div>
    <a className="font-bold text-2xl cursor-pointer">BookHub</a>
  </div>
  ...
  {authUser?<Logout/>:<div>
    <a className="btn px-5  dark:bg-black dark:text-white bg-slate-100 text-black hover:bg-stone-400 duration-300"
